...
cursor = con.cursor()
cursor.execute("select * from memberentry")
rows=cursor.fetchall()
ban=Frame(root, bg="#FAE5D3",borderwidth=4,relief="solid",width=800,height=500)
ban.pack(side="left",fill="y",anchor='center')

tv=ttk.Treeview(ban,columns=(1,2,3,4),show="headings",height = 33, selectmode = "extended")
# tv=ttk.Treeview(ban)
tv["columns"]=("1","2","3","4")
tv.column("1", width=270,anchor='center')
tv.column("2", width=270,anchor='center')
tv.column("3", width=270,anchor='center')
tv.column("4", width=273,anchor='center')

tv.heading(1,text="id")
tv.heading(2, text="Name")
tv.heading(3, text="In/Out")
tv.heading(4, text="Date/Time")
